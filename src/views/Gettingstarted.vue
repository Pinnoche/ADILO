        ...
        <div class="progress-section">
            ...
            <div class="steps">
                ...
                <div class="step completed">
                    <span class="material-icons checkmark">check_circle</span>
                    <div class="step-info">
                        <p class="step-title">Verify Your Account</p>
                        <p class="step-desc">Check your email or messages for a verification link</p>
                    </div>
                </div>
                <div class="step">
                    ...
                    <div class="step-info">
                        ...
                        <p class="step-desc">Complete your seller profile by providing essential information</p>
                    </div>
                </div>
                <div class="step">
                    ...
                    <div class="step-info">
                        ...
                        <p class="step-desc">Configure your payment settings and shipping preferences</p>
                    </div>
                </div>
                <div class="step">
                    <span class="material-icons icon">add_circle</span>
                    <div class="step-info">
                        <p class="step-title">Add Products or Services</p>
                        <p class="step-desc">Begin adding your products or services to the marketplace</p>
                    </div>
                </div>
                <div class="step">
                    ...
                    <div class="step-info">
                        ...
                        <p class="step-desc">Utilize promotional tools to increase visibility</p>
                    </div>
                </div>
            </div>
        </div>
